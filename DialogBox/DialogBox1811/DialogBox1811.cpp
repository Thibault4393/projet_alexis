...
// DialogBox1811.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CDialogBox1811App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CDialogBox1811App::OnAppAbout)
...
// Construction de CDialogBox1811App

CDialogBox1811App::CDialogBox1811App() noexcept
{
	...
	SetAppID(_T("DialogBox1811.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CDialogBox1811App

CDialogBox1811App theApp;


// Initialisation de CDialogBox1811App

BOOL CDialogBox1811App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDialogBox1811Doc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CDialogBox1811View));
	if (!pDocTemplate)
		return FALSE;
...
// gestionnaires de messages de CDialogBox1811App
...
void CDialogBox1811App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CDialogBox1811App

void CDialogBox1811App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDialogBox1811App::LoadCustomState()
{
}

void CDialogBox1811App::SaveCustomState()
{
}
